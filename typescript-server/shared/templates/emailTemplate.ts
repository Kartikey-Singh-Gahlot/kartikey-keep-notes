...
export const signupOtpVerificationMailTemplate = (msg:string):string =>{
    return (`
...
export const loginOtpVerificationMailTemplate = (otp:string):string => {
  return(`
    <div style="font-family: Arial, sans-serif; background-color: #f4f6f8; padding: 30px;">
      <div style="max-width: 500px; margin: auto; background-color: #ffffff; padding: 25px; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
...
export const contactMailTemplate = (email:string, message:string):string => {
  return `
    <div style="font-family: Arial, sans-serif; background-color: #f4f6f8; padding: 30px;">
...
export const contactAcknowledgementMailTemplate = (email:string):string => {
  return `
    <div style="font-family: Arial, sans-serif; background-color: #f4f6f8; padding: 30px;">
      <div style="max-width: 520px; margin: auto; background-color: #ffffff; padding: 25px; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
