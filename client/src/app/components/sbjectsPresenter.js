          ...
          <ul className="flex gap-5 w-full flex-wrap justify-start py-5">
            {
              subjects.map((subject, index)=>{
                  return(          
                      <Link href={'/auth/signin'} key={index} className={`min-w-[280px] max-w-[400px] flex flex-col w-full transition-colors text-nowrap px-4 py-2 rounded-[4px]  text-white hover:border-green-800 hover:bg-amber-50 hover:text-green-800 border border-[#ffffff00]  bg-green-800  cursor-pointer`}>
