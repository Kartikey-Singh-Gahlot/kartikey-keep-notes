...
export default function ContactForm({lightTheme:boolean}){
    ...
    return(
       (!loading)?
       (<form  onSubmit={(e)=>{trgrFormSubmit(e)}} className="contact-form">
            <input  required  onChange={(e)=>{ trgrFormChange(e)}} value={formData.sender} name="sender"     className="sender-input"  placeholder="xyz@gmail.com"/>
            <textarea onChange={(e)=>{ trgrFormChange(e)}} value={formData.message}        name="message"    className="message-input" placeholder="Your message for us"/>
